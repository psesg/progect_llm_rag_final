...
def img_prompt_func(data_dict):
    ...
    text_message = {
        ...
        "text": (
            ...
            f"В конце ответа обязательно укажи источники информации в формате файл - страница. Источники далее: {formatted_sources}\n\n "
...
# по текстовым данным
# "Что говорится о достижениях Сбера в его годовом отчете за 2023 год?"

# по изображению
# "Что написано в отчетe в годовом отчете Сбера за 2023 год на странице, где изображена женщина-велосипедист в защитном шлеме и очках на фоне размытого пейзажа и какой текст содержится, в правой части слайда - перечисли темы.")
# ожидаем 10-10
